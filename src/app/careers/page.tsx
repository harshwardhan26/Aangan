...
export default function CareersPage() {
  return (
    <>
      <Navbar />
      <main className="static-page-container page-container-narrow">
        <h1 className="page-title">Careers at Aangan</h1>
        <p className="text-muted" style={{ fontSize: '1.2rem', marginBottom: '40px', lineHeight: '1.8' }}>
        ...
        <div className="content-section" style={{ marginBottom: '40px', background: '#f8fafc', padding: '30px', borderRadius: '12px', border: '1px solid var(--border)' }}>
          ...
          <p className="text-muted">We currently do not have any open positions. Please check back later or send your resume to careers@aangan.com.</p>
        </div>
      </main>
      <Footer />
    </>
